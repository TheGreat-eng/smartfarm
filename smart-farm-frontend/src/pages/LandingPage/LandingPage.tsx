...
import { ArrowRight, BarChart, Bot, BrainCircuit, Sprout } from 'lucide-react';
...
const LandingPage: React.FC = () => {
    ...
    useEffect(() => {
        // LOGIC: Kiểm tra token, nếu có thì đá vào trang danh sách nông trại
    ...
    return (
        <div className="landing-page enhanced">
            ...
            <header className="landing-header glass">
                <div className="landing-logo" style={{ display: 'flex', alignItems: 'center', gap: 8, cursor: 'pointer' }} onClick={() => window.location.reload()}>
                    <Sprout color="#52c41a" size={28} />
                    <span className="gradient-text" style={{ fontSize: '1.5rem' }}>SmartFarm</span>
                </div>
                <div className="landing-nav">
                    <Button type="text" size="large" onClick={() => navigate('/login')}>Đăng nhập</Button>
                    <Button type="primary" size="large" className="btn-gradient" onClick={() => navigate('/register')}>Đăng ký ngay</Button>
                </div>
            </header>
                ...
                <Row justify="center" align="middle" style={{ height: '100%', position: 'relative' }}>
                    <Col xs={22} md={20} lg={16} xl={14} style={{ textAlign: 'center' }}>
                        <motion.div variants={containerVariants} initial="hidden" animate="visible">
                            ...
                            >
                                <span className="text-glow">Nông Trại Thông Minh 4.0</span>
                            </motion.h1>
                            ...
                            >
                                Giám sát, tự động hóa và tối ưu hóa trang trại của bạn với sức mạnh của dữ liệu thời gian thực và công nghệ IoT tiên tiến.
                            </motion.p>
                            ...
                            <motion.div variants={itemVariants} style={{ marginTop: '2.2rem' }}>
                                ...
                                >
                                    Bắt đầu miễn phí <ArrowRight size={20} style={{ marginLeft: 8 }} />
                                </Button>
                            </motion.div>
                        </motion.div>
                    </Col>
            ...
            <section className="landing-features pretty">
                <div className="landing-container" style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px' }}>
                    <Title level={2} style={{ textAlign: 'center', marginBottom: 18 }}>
                        <span className="section-badge">Tại sao chọn SmartFarm?</span>
                    </Title>
                    <Title level={2} style={{ textAlign: 'center', marginBottom: 60 }}>
                        Công nghệ hiện đại cho người nông dân
                    </Title>
                    <Row gutter={[32, 32]} justify="center">
                        <Col xs={24} md={12} lg={8}>
                            <FeatureCard
                                ...
                                description="Theo dõi nhiệt độ, độ ẩm, độ ẩm đất và ánh sáng từ bất cứ đâu qua Dashboard trực quan."
                            />
                        </Col>
                        <Col xs={24} md={12} lg={8}>
                            <FeatureCard
                                ...
                                description="Thiết lập quy tắc If-This-Then-That: Tự động bật máy bơm khi đất khô, bật đèn khi trời tối."
                            />
                        </Col>
                        <Col xs={24} md={12} lg={8}>
                            <FeatureCard
                                ...
                                description="Quản lý nhiều nông trại và hàng trăm thiết bị IoT trên cùng một giao diện duy nhất."
                            />
                        </Col>
                    </Row>
                </div>
            ...
            <section className="landing-cta shine">
                <div className="landing-container" style={{ textAlign: 'center', maxWidth: 800, margin: '0 auto', padding: '0 24px' }}>
                    <Title level={2} style={{ marginBottom: 12 }}>Sẵn sàng cách mạng hóa nông trại của bạn?</Title>
                    <Paragraph type="secondary" style={{ fontSize: '1.1rem', marginTop: 8 }}>
                        Tham gia cùng hàng ngàn nông dân hiện đại và nâng cao năng suất ngay hôm nay.
                    </Paragraph>
                    <Button
                        type="primary"
                        size="large"
            ...
            {/* ===== Footer Simple ===== */}
            <footer style={{ textAlign: 'center', padding: '40px 0', background: '#fff', borderTop: '1px solid #eee' }}>
                <Typography.Text type="secondary">© 2024 SmartFarm Project. All rights reserved.</Typography.Text>
            </footer>
        ...
        .landing-hero.fx {
          ...
          /* Thay đổi ảnh nền cho phù hợp nông trại */
          background-image:
